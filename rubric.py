...
DIMENSIONS = [
    ...
    },
    {
        ...
        "name": "AI Readiness",
        "weight": 0.50,
        "summary": "AI is reshaping every industry. This isn't about whether you're using it today. It is about whether you're positioned to adopt it when the time is right. A low score here is an opportunity, not a weakness.",
        "questions": [
            {
                "id": "ai_01",
